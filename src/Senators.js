...
export default class extends React.Component {
  ...
  renderRepublicans() {
    return this.filterByParty('Republican').map(senator => <Senator senator={senator} />)
  }

  renderDemocrats() {
    return this.filterByParty('Democrat').map(senator => <Senator senator={senator} />)
  }
  ...
  render() {
    ...
    return (
      <div>
        <form>
          <input type="search" placeholder="Search" value={this.state.query}
